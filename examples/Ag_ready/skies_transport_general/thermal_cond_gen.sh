...
####################################################################
#
# NOTE: the general case requires SpecFunc_pp_xx.dat and SpecFunc_mm_xx.dat files
# evaluated for a range of electronic energies around the Fermi energy
#
skies thermal-cond --range=[10,1400] --general < epw.skies.in
