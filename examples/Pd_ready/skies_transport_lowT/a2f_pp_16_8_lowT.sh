...
###################################################################################################
#
# NOTE: --bands=[3,5] is used to only consider the 3d to 5th bands in the calculation.
# It significantly speeds up the calculations.
#
skies a2f --kgrid=[16,16,16] --qgrid=[8,8,8] --signs=[1,1] --bands=[3,5] --eF=14.3494 --tetra < epw.skies.in
