...
######################################################################
#          Evaluates the Transport Density of States (TrDOS)	     #
######################################################################
#
# NOTE: the value of eF is obtained from the scf QE calculation:
# $ grep Fermi scf.out
#      the Fermi energy is    14.3494 ev
#
skies trdos --grid=[30,30,30] --eF=14.3494 --tetra --range=[-5,5] < epw.skies.in
